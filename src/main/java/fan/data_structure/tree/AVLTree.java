...
public class AVLTree {
     ...
     * 获取节点的高度, 空节点高度为 -1
     *
     * @param avlTreeNode 节点
     * @return {@link int}
     * @author Fan
     * @since 2023/6/1 11:36
     */
    public int getHeight(AVLTreeNode avlTreeNode) {
        return null == avlTreeNode ? -1 : avlTreeNode.height;
    }

    public void preOrder(AVLTreeNode avlTreeNode) {
        if (avlTreeNode == null) {
            return;
        }
        ...
        preOrder(avlTreeNode.leftChild);
        preOrder(avlTreeNode.rightChild);
    }
